...
class Statistical_Calculator_Test(UnitTestSCalculator.Unit_Test):
    ...
    def test_mean(self):
        test_cases= UnitTestSCalculator.Unit_Test.get_test_cases_from_file("UnitTestMean.csv")
    ...
    def test_zscore(self):
        test_cases = UnitTestSCalculator.Unit_Test.get_test_cases_from_file("UnitTestZScore.csv")
        for test_case in test_cases:
    ...
    def test_pop_corr_coeff(self):
        test_cases = UnitTestSCalculator.Unit_Test.get_test_cases_from_file("UnitTestPopulationCorrelationCoefficient.csv")
        for test_case in test_cases:
    ...
    def test_population_variance(self):
        test_cases = UnitTestSCalculator.Unit_Test.get_test_cases_from_file("UnitTestPopulationVariance.csv")
        for test_case in test_cases:
            test_case_values = test_case[:-1]
            test_case_result = test_case[-1]
    ...
    def test_sample_variance(self):
        test_cases = UnitTestSCalculator.Unit_Test.get_test_cases_from_file("UnitTestSampleVariance.csv")
        for test_case in test_cases:
            test_case_values = test_case[:-1]
            test_case_result = test_case[-1]
